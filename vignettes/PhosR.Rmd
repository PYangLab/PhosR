...
filtering, imputation, normalisation and batch correction, enabling integration 
...
In this example, we will use L6 myotube phosphoproteome dataset (with accession number PXD019127) and the SPSs we identified from a panel of phosphoproteomic datasets (please refer to the [PhosR Cell Reports paper](https://doi.org/10.1016/j.celrep.2021.108771) for the full list of the datasets used). The `SPSs` will be used as our `negative control` in RUV normalisation.
