...
author:
- name: Taiyun Kim, Hani Jieun Kim, Di Xiao
...
We will use `ppe_RUV` matrix from [batch_correction](../docs/webOnly/batch_correction.html).
...
# summary phosphosite-level information to proteins for performing downstream gene-centric analyses.
...
#pathways = pathways[which(grepl("R-RNO", names(pathways), ignore.case = TRUE))]
