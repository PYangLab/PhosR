...
p1 = plotQC(ppe@assays@data$Quantification, cols=colorCodes, labels = colnames(ppe), panel = "dendrogram" )
p2 = plotQC(ppe@assays@data$normalised, cols=colorCodes, labels = colnames(ppe), panel="dendrogram")
ggpubr::ggarrange(p1, p2, nrow = 1)
```

```{r}
p1 = plotQC(ppe@assays@data$Quantification, panel = "pca", cols=colorCodes, labels = colnames(ppe)) +
  ggplot2::ggtitle("Before Batch correction")
p2 = plotQC(ppe@assays@data$normalised, cols=colorCodes, labels = colnames(ppe), panel="pca") +
