...
par(mfrow=c(1,1))
plotQC(ppe, panel = 2, cols=colorCodes, main = "Before batch correction")
```
...
```{r}
par(mfrow=c(1,1))
plotQC(ppe, cols=colorCodes, labels = colnames(ppe), panel = 4, ylim=c(-20, 20), xlim=c(-30, 30), main = "Before batch correction")
```
...
par(mfrow=c(1,2))
plotQC(ppe@assays@data$Quantification, panel = 2, cols=colorCodes)
plotQC(ppe@assays@data$normalised, cols=colorCodes, labels = colnames(ppe), panel=2, ylim=c(-20, 20), xlim=c(-30, 30))
```

```{r}
par(mfrow=c(1,2))
plotQC(ppe@assays@data$Quantification, panel = 4, cols=colorCodes, labels = colnames(ppe), main="Before Batch correction")
plotQC(ppe@assays@data$normalised, cols=colorCodes, labels = colnames(ppe_RUV), panel=4, ylim=c(-20, 20), xlim=c(-30, 30), main="After Batch correction")
```
